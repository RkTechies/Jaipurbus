package com.codersworld.jplibs.utils;
...
import com.bumptech.glide.request.RequestOptions;
 import com.codersworld.jplibs.fancydialog.FancyAlertDialog;
import com.codersworld.jplibs.toast.FancyToast;
...
public class CommonMethods {
    ...
    public static void loadImage(Context context, String img, ImageView imageView) {
        if (isValidString(img)) {
            Glide.with(context)
                    .load(img)
                    .placeholder(R.drawable.app_icon_black)
                    .error(R.drawable.app_icon_black)
                    .into(imageView);
        }
    }
    ...
    public static void loadImageWithCenterCrop(Context context, String img, ImageView imageView) {
        if (isValidString(img)) {
            Glide.with(context)
                    .load(img)
                    .apply(new RequestOptions().placeholder(R.drawable.app_icon_black).error(R.drawable.app_icon_black))
                    .placeholder(R.drawable.app_icon_black)
                    .error(R.drawable.app_icon_black)
                    .into(imageView);
        }
   ...
   public static Vibrator getVibrator(Activity mActivity){
    ...
    public static void setBackground(Context ctx, String bagimg, RelativeLayout mLinearLayout) {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
                    ...
                    public void onGenerated(@Nullable Palette palette) {
                        ...
                        mLinearLayout.setBackgroundColor(vibrantLight);
                    }
                });
            }
